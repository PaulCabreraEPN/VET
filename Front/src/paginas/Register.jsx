...
export const Register = () => {
    ...
    // Paso 1. Crear un objeto vacío para obtener los datos del Input
    ...
    //Paso 2 función para ir llenando en tiempo real los datos
    ...
    const handleSubmit = async(e) => { 
        ...
        try {
            ...
            setMensaje({
                respuesta: respuesta.data.msg,tipo:true})
        } catch (error) {
            console.log(error);
                ...
                <div className="md:w-4/5 sm:w-full">
                    ...
                    <form onSubmit={handleSubmit}>
                        <div className="mb-3">
                            ...
                            placeholder="Enter your name" className="block w-full rounded-md border border-gray-300 focus:border-gray-700 focus:outline-none focus:ring-1 focus:ring-gray-700 py-1 px-1.5 text-gray-500" required />
                        </div>
